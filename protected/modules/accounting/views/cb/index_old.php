...
$('#dg-cheque').edatagrid({
	...
	saveUrl: '<?php echo $this->createUrl('cb/savecheque',array('grid'=>true))?>',
	updateUrl: '<?php echo $this->createUrl('cb/savecheque',array('grid'=>true))?>',
	...
	onBeforeSave: function(index){
		var row = $('#dg-cheque').edatagrid('getSelected');
		if (row)
		{
			row.cbid = $('#cbid').val();
		}
