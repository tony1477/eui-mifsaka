<?php
class RepapagingController extends Controller
{
  public $menuname = 'repapaging';
  ...
  public function actionDownPDF()
  {
    ...
    $sql              = "select az.*,
						...
						from
						(select c.fullname,a.invoiceno,a.invoicedate,d.paydays,
						date_add(a.invoicedate,interval d.paydays day) as dropdate,
						datediff(date_add(a.invoicedate,interval d.paydays day),current_date()) as diffdate,
						...
						inner join paymentmethod d on d.paymentmethodid = b.paymentmethodid
						where a.invoiceapid not in (
						select zz.invoiceapid from cbapinv zz 
						join cashbankout zzz on zzz.cashbankoutid = zz.cashbankoutid
						where zzz.recordstatus > 1) and
						a.paymentmethodid > 1 and a.recordstatus > 1 ) az ";
