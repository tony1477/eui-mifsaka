<table id="dg-deliveryadviceproductoutput" style="width:1200px;height:97%">
</table>
<div id="tb-deliveryadviceproductoutput">
...
<?php }?>
	<?php if (CheckAccess($this->menuname, $this->isdownload) == 1) {  ?>
		<a href="javascript:void(0)" title="Export Ke PDF"class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="downpdfdeliveryadviceproductoutput()"></a>
		<a href="javascript:void(0)" title="Export Ke EXCEL"class="easyui-linkbutton" iconCls="icon-xls" plain="true" onclick="downxlsdeliveryadviceproductoutput()"></a>
...
<td><input class="easyui-textbox" id="deliveryadviceproductoutput_search_deliveryadviceid" style="width:150px"></td>
<td><?php echo getCatalog('dano')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductoutput_search_dano" style="width:150px"></td>
<td><?php echo getCatalog('productoutput')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductoutput_search_productoutputid" style="width:150px"></td>
<td><?php echo getCatalog('dadate')?></td></td>
<td><input class="easyui-textbox" id="deliveryadviceproductoutput_search_dadate" style="width:150px"></td>
</tr>
<tr>
<td><?php echo getCatalog('useraccess')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductoutput_search_useraccessid" style="width:150px"></td>
<td><?php echo getCatalog('sloccode')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductoutput_search_slocid" style="width:150px"></td>
<td><?php echo getCatalog('headernote')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductoutput_search_headernote" style="width:150px"><a href="javascript:void(0)" title="Cari"class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="searchdeliveryadviceproductoutput()"></a></td>
</tr>
</table>
</div>

<div id="dlg-deliveryadviceproductoutput" class="easyui-dialog" title="Delivery Advice" style="width:auto;height:600px" 
	...
	toolbar: [
		...
		},
		{
			...
			iconCls:'icon-cancel',
			handler:function(){
					$('#dlg-deliveryadviceproductoutput').dialog('close');
			}
		},
	]	
	">
	<form id="ff-deliveryadviceproductoutput-modif" method="post" data-options="novalidate:true">
      ...
      <tr>
            ...
            <tr>
				...
				<td><select class="easyui-combogrid" name="productoutputid" id="productoutputid" style="width:250px" data-options="
								...
								required: true,
								pagination:true,
								url: '<?php echo Yii::app()->createUrl('production/productoutput/indexda',array('grid'=>true)) ?>',
								method: 'get',
								mode: 'remote',
								queryParams: {
									combo:true
								...
								onHidePanel: function(){
									jQuery.ajax({'url':'<?php echo $this->createUrl('deliveryadviceproductoutput/generateop') ?>',
											'data':{
											...
											{
												$('#dg-deliveryadviceproductoutput').edatagrid('reload');		
												$('#dg-deliveryadviceproductoutputdetail').edatagrid('reload');				
											},
											'cache':false});
											$('#dg-deliveryadviceproductoutputdetail').datagrid({
											queryParams: {
		...
		<div class="easyui-tabs" style="width:auto;height:400px">
			<div title="Detail" style="padding:5px">
				<table id="dg-deliveryadviceproductoutputdetail"  style="width:100%;height:300px">
				</table>
				<div id="tb-deliveryadviceproductoutputdetail">
					<a href="javascript:void(0)" title="Tambah"class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:$('#dg-deliveryadviceproductoutputdetail').edatagrid('addRow')"></a>
					<a href="javascript:void(0)" title="Simpan"class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true" onclick="javascript:$('#dg-deliveryadviceproductoutputdetail').edatagrid('saveRow')"></a>
					<a href="javascript:void(0)" title="Kembali"class="easyui-linkbutton" iconCls="icon-undo" plain="true" onclick="javascript:$('#dg-deliveryadviceproductoutputdetail').edatagrid('cancelRow')"></a>
					<a href="javascript:void(0)" title="Hapus"class="easyui-linkbutton" iconCls="icon-purge" plain="true" onclick="javascript:$('#dg-deliveryadviceproductoutputdetail').edatagrid('destroyRow')"></a>
				</div>
			</div>
	</div>
</div>
...
$('#deliveryadviceproductoutput_search_deliveryadviceid').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductoutput();
			}
		}
	})
});
$('#deliveryadviceproductoutput_search_dano').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductoutput();
...
$('#deliveryadviceproductoutput_search_slocid').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductoutput();
...
$('#deliveryadviceproductoutput_search_headernote').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductoutput();
...
$('#deliveryadviceproductoutput_search_useraccessid').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductoutput();
...
$('#deliveryadviceproductoutput_search_productoutputid').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductoutput();
...
$('#deliveryadviceproductoutput_search_dadate').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductoutput();
...
$('#dg-deliveryadviceproductoutput').edatagrid({
		iconCls: 'icon-edit',	
		singleSelect: false,
		toolbar:'#tb-deliveryadviceproductoutput',
		pagination: true,
		fitColumns:true,
		ctrlSelect:true,
   ...
   onExpandRow: function(index,row){
			...
			ddvdadetail.datagrid({
				url:'<?php echo $this->createUrl('deliveryadviceproductoutput/indexdetail',array('grid'=>true)) ?>?id='+row.deliveryadviceid,
				fitColumns:true,
				singleSelect:true,
				rownumbers:true,
          ...
          {field:'productname',title:'<?php echo getCatalog('productname') ?>'},
			...
			{field:'giqty',title:'<?php echo getCatalog('tfsqty') ?>',align:'right'},
				...
				onResize:function(){
						$('#dg-deliveryadviceproductoutput').datagrid('fixDetailRowHeight',index);
				},
    ...
    url: '<?php echo $this->createUrl('deliveryadviceproductoutput/index',array('grid'=>true)) ?>',
...
title:'<?php echo getCatalog('productoutput') ?>',
sortable: true,
width:'120px',
formatter: function(value,row,index){
...
function searchdeliveryadviceproductoutput(value){
	$('#dg-deliveryadviceproductoutput').edatagrid('load',{
	deliveryadviceid:$('#deliveryadviceproductoutput_search_deliveryadviceid').val(),
        dadate:$('#deliveryadviceproductoutput_search_dadate').val(),
        dano:$('#deliveryadviceproductoutput_search_dano').val(),
	productoutputid:$('#deliveryadviceproductoutput_search_productoutputid').val(),
        useraccessid:$('#deliveryadviceproductoutput_search_useraccessid').val(),
        slocid:$('#deliveryadviceproductoutput_search_slocid').val(),
        headernote:$('#deliveryadviceproductoutput_search_headernote').val(),
	});
}
function approveda() {
	var ss = [];
	var rows = $('#dg-deliveryadviceproductoutput').edatagrid('getSelections');
	for(var i=0; i<rows.length; i++){
			var row = rows[i];
			ss.push(row.deliveryadviceid);
	}
	jQuery.ajax({'url':'<?php echo $this->createUrl('deliveryadviceproductoutput/approve') ?>',
...
function cancelda() {
	...
	jQuery.ajax({'url':'<?php echo $this->createUrl('deliveryadviceproductoutput/delete') ?>',
		'data':{'id':ss},'type':'post','dataType':'json',
		'success':function(data)
		{
			show('Message',data.msg);
...
function downpdfdeliveryadviceproductoutput() 
{
	var ss = [];
	var rows = $('#dg-deliveryadviceproductoutput').edatagrid('getSelections');
	for(var i=0; i<rows.length; i++){
	...
	window.open('<?php echo $this->createUrl('deliveryadviceproductoutput/downpdf') ?>?id='+ss);
}
function downxlsdeliveryadviceproductoutput() 
{
	var ss = [];
	var rows = $('#dg-deliveryadviceproductoutput').edatagrid('getSelections');
	for(var i=0; i<rows.length; i++){
	...
	window.open('<?php echo $this->createUrl('deliveryadviceproductoutput/downxls') ?>?id='+ss);
}
    function downpdf1() {
	var ss = [];
	var rows = $('#dg-deliveryadviceproductoutput').edatagrid('getSelections');
...
function addDA() {
		$('#dlg-deliveryadviceproductoutput').dialog('open');
		$('#ff-deliveryadviceproductoutput-modif').form('clear');
		$('#ff-deliveryadviceproductoutput-modif').form('load','<?php echo $this->createUrl('deliveryadviceproductoutput/getdata') ?>');
		$('#dadate').datebox({
...
function editDA($i) {
	var row = $('#dg-deliveryadviceproductoutput').datagrid('getSelected');
	...
	if(row) {
		...
		{
		$('#dlg-deliveryadviceproductoutput').dialog('open');
		$('#ff-deliveryadviceproductoutput-modif').form('load',row);
		$('#dg-deliveryadviceproductoutputdetail').datagrid('load',{'id':row.deliveryadviceid});
		}
	}
	else {
...
function submitFormDA(){
	$('#ff-deliveryadviceproductoutput-modif').form('submit',{
		url:'<?php echo $this->createUrl('deliveryadviceproductoutput/save') ?>',
		onSubmit:function(){
        ...
        $('#dg-deliveryadviceproductoutput').datagrid('reload');
        $('#dlg-deliveryadviceproductoutput').dialog('close');
			}
    }
	});	
...
$('#ff-deliveryadviceproductoutput-modif').form({
...
$('#dg-deliveryadviceproductoutputdetail').edatagrid({
	iconCls: 'icon-edit',	
	singleSelect: false,
	idField:'deliveryadvicedetailid',
	editing: true,
	toolbar:'#tb-deliveryadviceproductoutputdetail',
	fitColumn: true,
	pagination:true,
	url: '<?php echo $this->createUrl('deliveryadviceproductoutput/searchdetail',array('grid'=>true)) ?>',
	saveUrl: '<?php echo $this->createUrl('deliveryadviceproductoutput/savedetail',array('grid'=>true))?>',
	updateUrl: '<?php echo $this->createUrl('deliveryadviceproductoutput/savedetail',array('grid'=>true))?>',
	destroyUrl: '<?php echo $this->createUrl('deliveryadviceproductoutput/purgedetail',array('grid'=>true))?>',
	onSuccess: function(index,row){
		show('Pesan',row.msg);
		$('#dg-deliveryadviceproductoutputdetail').edatagrid('reload');
	},
				...
				options:{
						...
						onChange:function(newValue,oldValue) {
							if ((newValue !== oldValue) && (newValue !== ''))
							{
								...
								var productid = $("#dg-deliveryadviceproductoutputdetail").datagrid("getEditor", {index: index, field:"productid"});
								var unitofmeasureid = $("#dg-deliveryadviceproductoutputdetail").datagrid("getEditor", {index: index, field:"unitofmeasureid"});
								var slocid = $("#dg-deliveryadviceproductoutputdetail").datagrid("getEditor", {index: index, field:"slocid"});
