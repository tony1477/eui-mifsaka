<table id="dg-deliveryadviceproductplan" style="width:1200px;height:97%">
</table>
<div id="tb-deliveryadviceproductplan">
	<?php
...
<?php }?>
	<?php if (CheckAccess($this->menuname, $this->isdownload) == 1) {  ?>
		<a href="javascript:void(0)" title="Export Ke PDF"class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="downpdfdeliveryadviceproductplan()"></a>
		<a href="javascript:void(0)" title="Export Ke EXCEL"class="easyui-linkbutton" iconCls="icon-xls" plain="true" onclick="downxlsdeliveryadviceproductplan()"></a>
...
<td><input class="easyui-textbox" id="deliveryadviceproductplan_search_deliveryadviceid" style="width:150px"></td>
<td><?php echo getCatalog('dano')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductplan_search_dano" style="width:150px"></td>
<td><?php echo getCatalog('productplan')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductplan_search_productplanid" style="width:150px"></td>
<td><?php echo getCatalog('dadate')?></td></td>
<td><input class="easyui-textbox" id="deliveryadviceproductplan_search_dadate" style="width:150px"></td>
</tr>
<tr>
<td><?php echo getCatalog('useraccess')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductplan_search_useraccessid" style="width:150px"></td>
<td><?php echo getCatalog('sloccode')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductplan_search_slocid" style="width:150px"></td>
<td><?php echo getCatalog('headernote')?></td>
<td><input class="easyui-textbox" id="deliveryadviceproductplan_search_headernote" style="width:150px"><a href="javascript:void(0)" title="Cari"class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="searchdeliveryadviceproductplan()"></a></td>
</tr>
</table>
</div>

<div id="dlg-deliveryadviceproductplan" class="easyui-dialog" title="Delivery Advice SPP" style="width:auto;height:600px" 
	...
	toolbar: [
		...
		},
		{
			...
			iconCls:'icon-cancel',
			handler:function(){
					$('#dlg-deliveryadviceproductplan').dialog('close');
			}
		},
	]	
	">
	<form id="ff-deliveryadviceproductplan-modif" method="post" data-options="novalidate:true">
      ...
      <tr>
			...
			<tr>
				...
				<td><select class="easyui-combogrid" name="productplanid" id="productplanid" style="width:250px" data-options="
								...
								onHidePanel: function(){
									jQuery.ajax({'url':'<?php echo $this->createUrl('deliveryadviceproductplan/generatespp') ?>',
											'data':{
													'id':$('#productplanid').combogrid('getValue'),
											...
											{
												$('#dg-deliveryadviceproductplan').edatagrid('reload');		
												$('#dg-deliveryadviceproductplandetail').edatagrid('reload');				
											},
											'cache':false});
									
										$('#dg-deliveryadviceproductplandetail').datagrid({
										queryParams: {
		...
		<div class="easyui-tabs" style="width:auto;height:400px">
			<div title="Detail" style="padding:5px">
				<table id="dg-deliveryadviceproductplandetail"  style="width:100%;height:300px">
				</table>
				<div id="tb-deliveryadviceproductplandetail">
					<a href="javascript:void(0)" title="Simpan"class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true" onclick="javascript:$('#dg-deliveryadviceproductplandetail').edatagrid('saveRow')"></a>
					<a href="javascript:void(0)" title="Kembali"class="easyui-linkbutton" iconCls="icon-undo" plain="true" onclick="javascript:$('#dg-deliveryadviceproductplandetail').edatagrid('cancelRow')"></a>
					<a href="javascript:void(0)" title="Hapus"class="easyui-linkbutton" iconCls="icon-purge" plain="true" onclick="javascript:$('#dg-deliveryadviceproductplandetail').edatagrid('destroyRow')"></a>
				</div>
			</div>
	</div>
</div>
...
$('#deliveryadviceproductplan_search_deliveryadviceid').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductplan();
			}
		}
	})
});
$('#deliveryadviceproductplan_search_dano').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductplan();
...
$('#deliveryadviceproductplan_search_slocid').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductplan();
...
$('#deliveryadviceproductplan_search_headernote').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductplan();
...
$('#deliveryadviceproductplan_search_useraccessid').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductplan();
...
$('#deliveryadviceproductplan_search_productplanid').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
				searchdeliveryadviceproductplan();
...
$('#deliveryadviceproductplan_search_dadate').textbox({
	inputEvents:$.extend({},$.fn.textbox.defaults.inputEvents,{
		keyup:function(e){
			if (e.keyCode == 13) {
...
$('#dg-deliveryadviceproductplan').edatagrid({
		iconCls: 'icon-edit',	
		singleSelect: false,
		toolbar:'#tb-deliveryadviceproductplan',
		pagination: true,
		fitColumns:true,
		ctrlSelect:true,
   ...
   onExpandRow: function(index,row){
			...
			ddvdadetail.datagrid({
				url:'<?php echo $this->createUrl('deliveryadviceproductplan/indexdetail',array('grid'=>true)) ?>?id='+row.deliveryadviceid,
				fitColumns:true,
				singleSelect:true,
				rownumbers:true,
          ...
          {field:'productname',title:'<?php echo getCatalog('productname') ?>'},
			...
			{field:'giqty',title:'<?php echo getCatalog('tfsqty') ?>',align:'right'},
				...
				onResize:function(){
						$('#dg-deliveryadviceproductplan').datagrid('fixDetailRowHeight',index);
				},
    ...
    url: '<?php echo $this->createUrl('deliveryadviceproductplan/index',array('grid'=>true)) ?>',
...
formatter: function(value,row,index){
	if (row.warna == 1) {
				return '<div style="background-color:cyan;color:black">'+value+'</div>';
					...
					{
field:'productplanid',
title:'<?php echo getCatalog('productplan') ?>',
sortable: true,
width:'200px',
formatter: function(value,row,index){
...
function searchdeliveryadviceproductplan(value){
	$('#dg-deliveryadviceproductplan').edatagrid('load',{
	deliveryadviceid:$('#deliveryadviceproductplan_search_deliveryadviceid').val(),
        dadate:$('#deliveryadviceproductplan_search_dadate').val(),
        dano:$('#deliveryadviceproductplan_search_dano').val(),
	productplanid:$('#deliveryadviceproductplan_search_productplanid').val(),
        useraccessid:$('#deliveryadviceproductplan_search_useraccessid').val(),
        slocid:$('#deliveryadviceproductplan_search_slocid').val(),
        headernote:$('#deliveryadviceproductplan_search_headernote').val(),
	});
}
function approveda() {
	var ss = [];
	var rows = $('#dg-deliveryadviceproductplan').edatagrid('getSelections');
	for(var i=0; i<rows.length; i++){
			var row = rows[i];
			ss.push(row.deliveryadviceid);
	}
	jQuery.ajax({'url':'<?php echo $this->createUrl('deliveryadviceproductplan/approve') ?>',
...
function cancelda() {
	...
	jQuery.ajax({'url':'<?php echo $this->createUrl('deliveryadviceproductplan/delete') ?>',
		'data':{'id':ss},'type':'post','dataType':'json',
		'success':function(data)
		{
			show('Message',data.msg);
...
function downpdfdeliveryadviceproductplan() 
{
	var ss = [];
	var rows = $('#dg-deliveryadviceproductplan').edatagrid('getSelections');
	for(var i=0; i<rows.length; i++){
	...
	window.open('<?php echo $this->createUrl('deliveryadviceproductplan/downpdf') ?>?id='+ss);
}
function downxlsdeliveryadviceproductplan() 
{
	var ss = [];
	var rows = $('#dg-deliveryadviceproductplan').edatagrid('getSelections');
	for(var i=0; i<rows.length; i++){
	...
	window.open('<?php echo $this->createUrl('deliveryadviceproductplan/downxls') ?>?id='+ss);
}
    function downpdf1() {
	var ss = [];
	var rows = $('#dg-deliveryadviceproductplan').edatagrid('getSelections');
...
function addDA() {
		$('#dlg-deliveryadviceproductplan').dialog('open');
		$('#ff-deliveryadviceproductplan-modif').form('clear');
		$('#ff-deliveryadviceproductplan-modif').form('load','<?php echo $this->createUrl('deliveryadviceproductplan/getdata') ?>');
		$('#dadate').datebox({
...
function editDA($i) {
	var row = $('#dg-deliveryadviceproductplan').datagrid('getSelected');
	...
	if(row) {
		...
		{
		$('#dlg-deliveryadviceproductplan').dialog('open');
		$('#ff-deliveryadviceproductplan-modif').form('load',row);
		$('#dg-deliveryadviceproductplandetail').datagrid('load',{'id':row.deliveryadviceid});
		}
	}
	else {
...
function submitFormDA(){
	$('#ff-deliveryadviceproductplan-modif').form('submit',{
		url:'<?php echo $this->createUrl('deliveryadviceproductplan/save') ?>',
		onSubmit:function(){
        ...
        $('#dg-deliveryadviceproductplan').datagrid('reload');
        $('#dlg-deliveryadviceproductplan').dialog('close');
			}
    }
	});	
...
$('#ff-deliveryadviceproductplan-modif').form({
...
$('#dg-deliveryadviceproductplandetail').edatagrid({
	iconCls: 'icon-edit',	
	singleSelect: false,
	idField:'deliveryadvicedetailid',
	editing: true,
	toolbar:'#tb-deliveryadviceproductplandetail',
	fitColumn: true,
	pagination:true,
	url: '<?php echo $this->createUrl('deliveryadviceproductplan/searchdetail',array('grid'=>true)) ?>',
	saveUrl: '<?php echo $this->createUrl('deliveryadviceproductplan/savedetail',array('grid'=>true))?>',
	updateUrl: '<?php echo $this->createUrl('deliveryadviceproductplan/savedetail',array('grid'=>true))?>',
	destroyUrl: '<?php echo $this->createUrl('deliveryadviceproductplan/purgedetail',array('grid'=>true))?>',
	onSuccess: function(index,row){
		show('Pesan',row.msg);
		$('#dg-deliveryadviceproductplandetail').edatagrid('reload');
	},
				...
				options:{
						...
						onChange:function(newValue,oldValue) {
							if ((newValue !== oldValue) && (newValue !== ''))
							{
								...
								var productid = $("#dg-deliveryadviceproductplandetail").datagrid("getEditor", {index: index, field:"productid"});
								var unitofmeasureid = $("#dg-deliveryadviceproductplandetail").datagrid("getEditor", {index: index, field:"unitofmeasureid"});
								var slocid = $("#dg-deliveryadviceproductplandetail").datagrid("getEditor", {index: index, field:"slocid"});
