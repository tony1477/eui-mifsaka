...
<tr>		
    <td id="sales_addressbookid"><?php echo GetCatalog('customer')?></td>
		<td><select class="easyui-combogrid" id="reportinventory_addressbookid" name="reportinventory_addressbookid" style="width:350px" data-options="
								panelWidth: 500,
								idField: 'fullname',
								textField: 'fullname',
								pagination:true,
...
function downpdfreportinventory() {
	window.open('<?php echo $this->createUrl('reportinventory/downpdf') ?>?lro='+
		...
		'&customer='+$('#reportinventory_addressbookid').combogrid('getValue')+
