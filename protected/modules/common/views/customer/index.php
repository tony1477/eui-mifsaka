<?php $this->widget('Form',	array('menuname'=>$this->menuname,
	...
	'searchfield'=> array ('addressbookid','fullname','bankname','accountowner','areaname','groupcustomer'),
	'headerform'=> "
		...
		<table cellpadding='5'>
			...
			<tr>
				...
				<td><select class='easyui-combogrid' name='pricecategoryid' style='width:250px' data-options=\"
						panelWidth: 500,
