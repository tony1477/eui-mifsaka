<?php $this->widget('Form',	array('menuname'=>$this->menuname,
	'idfield'=>'reportin',
	'formtype'=>'master',
	'url'=>Yii::app()->createUrl('hr/reportin/index',array('grid'=>true)),
	
	'downpdf'=>Yii::app()->createUrl('hr/reportin/downpdf'),
	'downxls'=>Yii::app()->createUrl('hr/reportin/downxls'),
	'columns'=>"
		{
			field:'reportinid',
			title:'". GetCatalog('reportinid') ."',
			sortable: true,
			width:'50',
