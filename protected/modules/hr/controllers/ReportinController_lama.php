...
class ReportinController extends Controller
{
	...
	public function search()
	{
		...
		// search 
		$reportinid = isset ($_POST['reportinid']) ? $_POST['reportinid'] : '';
...
$d31 = isset ($_POST['d31']) ? $_POST['d31'] : '';
		$reportinid = isset ($_GET['q']) ? $_GET['q'] : $reportinid;
...
$d31 = isset ($_GET['q']) ? $_GET['q'] : $d31;
	...
	$sort = isset($_POST['sort']) ? strval($_POST['sort']) : 'reportinid';
	...
	$cmd = Yii::app()->db->createCommand()
		...
		->from('reportin t')
		->where('((reportinid like :reportinid) or
...
'd31'=>$data['d31'],
	...
	public function actionSave()
	{
		...
		try
		{
			...
			{
				$sql = 'call Insertreportin(:vemployeeid,:vfullname,:voldnik,:vfulldivision,:vmonth,:vyear,:vs1,:vd1,:vs2,:vd2,:vs3,:vd3,:vs4,:vd4,:vs5,:vd5,:vs6,:vd6,:vs7,:vd7,:vs8,:vd8,:vs9,:vd9,:vs10,:vd10,:vs11,:vd11,:vs12,:vd12,:vs13,:vd13,:vs14,:vd14,:vs15,:vd15,:vs16,:vd16,:vs17,:vd17,:vs18,:vd18,:vs19,:vd19,:vs20,:vd20,:vs21,:vd21,:vs22,:vd22,:vs23,:vd23,:vs24,:vd24,:vs25,:vd25,:vs26,:vd26,:vs27,:vd27,:vs28,:vd28,:vs29,:vd29,:vs30,:vd30,:vs31,:vd31,:vcreatedby)';
				$command=$connection->createCommand($sql);
			}
			else
			{
				$sql = 'call Updatereportin(:vid,:vemployeeid,:vfullname,:voldnik,:vfulldivision,:vmonth,:vyear,:vs1,:vd1,:vs2,:vd2,:vs3,:vd3,:vs4,:vd4,:vs5,:vd5,:vs6,:vd6,:vs7,:vd7,:vs8,:vd8,:vs9,:vd9,:vs10,:vd10,:vs11,:vd11,:vs12,:vd12,:vs13,:vd13,:vs14,:vd14,:vs15,:vd15,:vs16,:vd16,:vs17,:vd17,:vs18,:vd18,:vs19,:vd19,:vs20,:vd20,:vs21,:vd21,:vs22,:vd22,:vs23,:vd23,:vs24,:vd24,:vs25,:vd25,:vs26,:vd26,:vs27,:vd27,:vs28,:vd28,:vs29,:vd29,:vs30,:vd30,:vs31,:vd31,:vcreatedby)';
				$command=$connection->createCommand($sql);
				$command->bindvalue(':vid',$_POST['reportinid'],PDO::PARAM_STR);
				$this->DeleteLock($this->menuname, $_POST['reportinid']);
			}
...
$command->bindvalue(':vd31',$_POST['d31'],PDO::PARAM_STR);
	...
	public function actionPurge()
	{
		...
		if (isset($_POST['id']))
		{
			...
			try
			{
				$sql = 'call Purgereportin(:vid,:vcreatedby)';
				$command=$connection->createCommand($sql);
				foreach($id as $ids)
				{
...
->setCellValueByColumnAndRow(4,1,getCatalog('month'))
->setCellValueByColumnAndRow(5,1,getCatalog('year'))
->setCellValueByColumnAndRow(6,1,getCatalog('s1'))
->setCellValueByColumnAndRow(7,1,getCatalog('d1'))
->setCellValueByColumnAndRow(8,1,getCatalog('s2'))
->setCellValueByColumnAndRow(9,1,getCatalog('d2'))
->setCellValueByColumnAndRow(10,1,getCatalog('s3'))
->setCellValueByColumnAndRow(11,1,getCatalog('d3'))
->setCellValueByColumnAndRow(12,1,getCatalog('s4'))
->setCellValueByColumnAndRow(13,1,getCatalog('d4'))
->setCellValueByColumnAndRow(14,1,getCatalog('s5'))
->setCellValueByColumnAndRow(15,1,getCatalog('d5'))
->setCellValueByColumnAndRow(16,1,getCatalog('s6'))
->setCellValueByColumnAndRow(17,1,getCatalog('d6'))
->setCellValueByColumnAndRow(18,1,getCatalog('s7'))
->setCellValueByColumnAndRow(19,1,getCatalog('d7'))
->setCellValueByColumnAndRow(20,1,getCatalog('s8'))
->setCellValueByColumnAndRow(21,1,getCatalog('d8'))
->setCellValueByColumnAndRow(22,1,getCatalog('s9'))
->setCellValueByColumnAndRow(23,1,getCatalog('d9'))
->setCellValueByColumnAndRow(24,1,getCatalog('s10'))
->setCellValueByColumnAndRow(25,1,getCatalog('d10'))
->setCellValueByColumnAndRow(26,1,getCatalog('s11'))
->setCellValueByColumnAndRow(27,1,getCatalog('d11'))
->setCellValueByColumnAndRow(28,1,getCatalog('s12'))
->setCellValueByColumnAndRow(29,1,getCatalog('d12'))
->setCellValueByColumnAndRow(30,1,getCatalog('s13'))
->setCellValueByColumnAndRow(31,1,getCatalog('d13'))
->setCellValueByColumnAndRow(32,1,getCatalog('s14'))
->setCellValueByColumnAndRow(33,1,getCatalog('d14'))
->setCellValueByColumnAndRow(34,1,getCatalog('s15'))
->setCellValueByColumnAndRow(35,1,getCatalog('d15'))
->setCellValueByColumnAndRow(36,1,getCatalog('s16'))
->setCellValueByColumnAndRow(37,1,getCatalog('d16'))
->setCellValueByColumnAndRow(38,1,getCatalog('s17'))
->setCellValueByColumnAndRow(39,1,getCatalog('d17'))
->setCellValueByColumnAndRow(40,1,getCatalog('s18'))
->setCellValueByColumnAndRow(41,1,getCatalog('d18'))
->setCellValueByColumnAndRow(42,1,getCatalog('s19'))
->setCellValueByColumnAndRow(43,1,getCatalog('d19'))
->setCellValueByColumnAndRow(44,1,getCatalog('s20'))
->setCellValueByColumnAndRow(45,1,getCatalog('d20'))
->setCellValueByColumnAndRow(46,1,getCatalog('s21'))
->setCellValueByColumnAndRow(47,1,getCatalog('d21'))
->setCellValueByColumnAndRow(48,1,getCatalog('s22'))
->setCellValueByColumnAndRow(49,1,getCatalog('d22'))
->setCellValueByColumnAndRow(50,1,getCatalog('s23'))
->setCellValueByColumnAndRow(51,1,getCatalog('d23'))
->setCellValueByColumnAndRow(52,1,getCatalog('s24'))
->setCellValueByColumnAndRow(53,1,getCatalog('d24'))
->setCellValueByColumnAndRow(54,1,getCatalog('s25'))
->setCellValueByColumnAndRow(55,1,getCatalog('d25'))
->setCellValueByColumnAndRow(56,1,getCatalog('s26'))
->setCellValueByColumnAndRow(57,1,getCatalog('d26'))
->setCellValueByColumnAndRow(58,1,getCatalog('s27'))
->setCellValueByColumnAndRow(59,1,getCatalog('d27'))
->setCellValueByColumnAndRow(60,1,getCatalog('s28'))
->setCellValueByColumnAndRow(61,1,getCatalog('d28'))
->setCellValueByColumnAndRow(62,1,getCatalog('s29'))
->setCellValueByColumnAndRow(63,1,getCatalog('d29'))
->setCellValueByColumnAndRow(64,1,getCatalog('s30'))
->setCellValueByColumnAndRow(65,1,getCatalog('d30'))
->setCellValueByColumnAndRow(66,1,getCatalog('s31'))
->setCellValueByColumnAndRow(67,1,getCatalog('d31'))
;		foreach($dataReader as $row1)
		{
			  $excel->setActiveSheetIndex(0)
...
->setCellValueByColumnAndRow(4, $i+1, $row1['month'])
->setCellValueByColumnAndRow(5, $i+1, $row1['year'])
->setCellValueByColumnAndRow(6, $i+1, $row1['s1'])
->setCellValueByColumnAndRow(7, $i+1, $row1['d1'])
->setCellValueByColumnAndRow(8, $i+1, $row1['s2'])
->setCellValueByColumnAndRow(9, $i+1, $row1['d2'])
->setCellValueByColumnAndRow(10, $i+1, $row1['s3'])
->setCellValueByColumnAndRow(11, $i+1, $row1['d3'])
->setCellValueByColumnAndRow(12, $i+1, $row1['s4'])
->setCellValueByColumnAndRow(13, $i+1, $row1['d4'])
->setCellValueByColumnAndRow(14, $i+1, $row1['s5'])
->setCellValueByColumnAndRow(15, $i+1, $row1['d5'])
->setCellValueByColumnAndRow(16, $i+1, $row1['s6'])
->setCellValueByColumnAndRow(17, $i+1, $row1['d6'])
->setCellValueByColumnAndRow(18, $i+1, $row1['s7'])
->setCellValueByColumnAndRow(19, $i+1, $row1['d7'])
->setCellValueByColumnAndRow(20, $i+1, $row1['s8'])
->setCellValueByColumnAndRow(21, $i+1, $row1['d8'])
->setCellValueByColumnAndRow(22, $i+1, $row1['s9'])
->setCellValueByColumnAndRow(23, $i+1, $row1['d9'])
->setCellValueByColumnAndRow(24, $i+1, $row1['s10'])
->setCellValueByColumnAndRow(25, $i+1, $row1['d10'])
->setCellValueByColumnAndRow(26, $i+1, $row1['s11'])
->setCellValueByColumnAndRow(27, $i+1, $row1['d11'])
->setCellValueByColumnAndRow(28, $i+1, $row1['s12'])
->setCellValueByColumnAndRow(29, $i+1, $row1['d12'])
->setCellValueByColumnAndRow(30, $i+1, $row1['s13'])
->setCellValueByColumnAndRow(31, $i+1, $row1['d13'])
->setCellValueByColumnAndRow(32, $i+1, $row1['s14'])
->setCellValueByColumnAndRow(33, $i+1, $row1['d14'])
->setCellValueByColumnAndRow(34, $i+1, $row1['s15'])
->setCellValueByColumnAndRow(35, $i+1, $row1['d15'])
->setCellValueByColumnAndRow(36, $i+1, $row1['s16'])
->setCellValueByColumnAndRow(37, $i+1, $row1['d16'])
->setCellValueByColumnAndRow(38, $i+1, $row1['s17'])
->setCellValueByColumnAndRow(39, $i+1, $row1['d17'])
->setCellValueByColumnAndRow(40, $i+1, $row1['s18'])
->setCellValueByColumnAndRow(41, $i+1, $row1['d18'])
->setCellValueByColumnAndRow(42, $i+1, $row1['s19'])
->setCellValueByColumnAndRow(43, $i+1, $row1['d19'])
->setCellValueByColumnAndRow(44, $i+1, $row1['s20'])
->setCellValueByColumnAndRow(45, $i+1, $row1['d20'])
->setCellValueByColumnAndRow(46, $i+1, $row1['s21'])
->setCellValueByColumnAndRow(47, $i+1, $row1['d21'])
->setCellValueByColumnAndRow(48, $i+1, $row1['s22'])
->setCellValueByColumnAndRow(49, $i+1, $row1['d22'])
->setCellValueByColumnAndRow(50, $i+1, $row1['s23'])
->setCellValueByColumnAndRow(51, $i+1, $row1['d23'])
->setCellValueByColumnAndRow(52, $i+1, $row1['s24'])
->setCellValueByColumnAndRow(53, $i+1, $row1['d24'])
->setCellValueByColumnAndRow(54, $i+1, $row1['s25'])
->setCellValueByColumnAndRow(55, $i+1, $row1['d25'])
->setCellValueByColumnAndRow(56, $i+1, $row1['s26'])
->setCellValueByColumnAndRow(57, $i+1, $row1['d26'])
->setCellValueByColumnAndRow(58, $i+1, $row1['s27'])
->setCellValueByColumnAndRow(59, $i+1, $row1['d27'])
->setCellValueByColumnAndRow(60, $i+1, $row1['s28'])
->setCellValueByColumnAndRow(61, $i+1, $row1['d28'])
->setCellValueByColumnAndRow(62, $i+1, $row1['s29'])
->setCellValueByColumnAndRow(63, $i+1, $row1['d29'])
->setCellValueByColumnAndRow(64, $i+1, $row1['s30'])
->setCellValueByColumnAndRow(65, $i+1, $row1['d30'])
->setCellValueByColumnAndRow(66, $i+1, $row1['s31'])
->setCellValueByColumnAndRow(67, $i+1, $row1['d31'])
;		$i+=1;
		}
