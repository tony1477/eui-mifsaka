 ...
 if (CheckAccess($this->menuname, $this->isdownload) == 1) {  ?>
    <table>
        <tr>
            ...
            <td><select class="easyui-combobox" id="listreppurchase" name="listreppurchase" data-options="required:true" style="width:250px;">
        ...
        <tr>
            ...
            <td><select class="easyui-combogrid" id="reppurchase_companyid" name="reppurchase_companyid" style="width:250px" data-options="
								panelWidth: 500,
								required: true,
								idField: 'companyid',
        ...
        <tr>
            ...
            <td><select class="easyui-combogrid" id="reppurchase_addressbookid" name="reppurchase_addressbookid" style="width:250px" data-options="
								panelWidth: 500,
								idField: 'fullname',
								textField: 'fullname',
								pagination:true,
        ...
        <tr>
            ...
            <td> <select class="easyui-combogrid" id="reppurchase_productid" name="reppurchase_productid" style="width:250px" data-options="
								panelWidth: 500,
								idField: 'productname',
        ...
        <tr>
            ...
            <td><input class="easyui-datebox" id="reppurchase_startdate" name="reppurchase_startdate" data-options="required:true" width="1066px"></input>
		-
		<input class="easyui-datebox" id="reppurchase_enddate" name="reppurchase_enddate" data-options="required:true"></input>
		...
		<a href="javascript:void(0)" title="Export Ke EXCEL" class="easyui-linkbutton" iconCls="icon-xls" plain="true" onclick="downxlsreportpurchasing()"></a></td>
		</tr>
    </table>
<?php }?>
</div>
