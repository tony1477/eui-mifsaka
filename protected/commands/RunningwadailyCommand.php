<?php
class RunningwadailyCommand extends CConsoleCommand
{
...
$msg = '\nPD 1-30      '.Yii::app()->numberFormatter->formatCurrency($row9['0sd30']/$per,'Rp.').'      '.Yii::app()->numberFormatter->formatCurrency(($row9['0sd30']/($row9['0sd30']+$row9['31sd60']+$row9['61sd90']+$row9['91sd120']+$row9['up120']))* 100,'').' %';
$pesan .= $msg;

$msg = '\nPD 31-60    '.Yii::app()->numberFormatter->formatCurrency($row9['31sd60']/$per,'Rp.').'      '.Yii::app()->numberFormatter->formatCurrency(($row9['31sd60']/($row9['0sd30']+$row9['31sd60']+$row9['61sd90']+$row9['91sd120']+$row9['up120']))* 100,'').' %';
$pesan .= $msg;

$msg = '\nPD 61-90    '.Yii::app()->numberFormatter->formatCurrency($row9['61sd90']/$per,'Rp.').'      '.Yii::app()->numberFormatter->formatCurrency(($row9['61sd90']/($row9['0sd30']+$row9['31sd60']+$row9['61sd90']+$row9['91sd120']+$row9['up120']))* 100,'').' %';
$pesan .= $msg;

$msg = '\nPD 91-120  '.Yii::app()->numberFormatter->formatCurrency($row9['91sd120']/$per,'Rp.').'      '.Yii::app()->numberFormatter->formatCurrency(($row9['91sd120']/($row9['0sd30']+$row9['31sd60']+$row9['61sd90']+$row9['91sd120']+$row9['up120']))* 100,'').' %';
$pesan .= $msg;

$msg = '\nPD > 120    '.Yii::app()->numberFormatter->formatCurrency($row9['up120']/$per,'Rp.').'      '.Yii::app()->numberFormatter->formatCurrency(($row9['up120']/($row9['0sd30']+$row9['31sd60']+$row9['61sd90']+$row9['91sd120']+$row9['up120']))* 100,'').' %';
$pesan .= $msg;
