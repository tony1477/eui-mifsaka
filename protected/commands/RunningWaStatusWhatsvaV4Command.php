<?php
class RunningWaStatusWhatsvaV4Command extends CConsoleCommand
{
	public function run($args)
	{
		...
		//Whatsva
			...
			CURLOPT_URL => "https://v4.whatsva.com/api/sendText?id_device=22&tujuan=".$whatsvano."@s.whatsapp.net&message=".urlencode("Status WA V4 Otomatis: *PHONE ONLINE*\n\n".$time)."&id_user=44",
...
/*			$ch = curl_init();
			curl_setopt_array($ch, array(
				CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan".$whatsvagroup."@g.us=&message=".urlencode("Status WA V4 Otomatis: *PHONE ONLINE*\n\n".$time)."&id_user=44",
				  CURLOPT_RETURNTRANSFER => true,
				  CURLOPT_ENCODING => "",
				  CURLOPT_MAXREDIRS => 10,
				  CURLOPT_TIMEOUT => 0,
