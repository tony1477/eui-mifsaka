<?php
class RunningWaTeleReminderKasirDailyWoowaCommand extends CConsoleCommand
{
	public function run($args)
	{
		...
		try
		{
			...
			$sqluser = "select distinct wanumber,telegramid,username,realname
						from useraccess a
					...
					union
						select distinct wanumber,telegramid,username,realname
						from useraccess a
						join usergroup b on b.useraccessid = a.useraccessid
						join groupaccess c on c.groupaccessid = b.groupaccessid
						join groupmenuauth d on d.groupaccessid=c.groupaccessid
