<?php
class RunningTeleWaPiutCashWhatsvaV4Command extends CConsoleCommand
{
				...
				foreach ($dataReader1 as $data1)
				{
					...
					if ($i < 41) {
						...
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage1)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
					...
					if ($i < 81) {
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage2)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage3)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
					...
					if ($i < 121) {
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage4)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage5)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage6)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
					...
					if ($i < 161) {
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage7)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage8)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage9)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage10)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
					...
					if ($i < 201) {
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage11)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage12)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage13)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage14)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
						...
						$ch = curl_init();
						curl_setopt_array($ch, array(
							CURLOPT_URL => https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$wagroupid."@g.us&message=".urlencode($wamessage15)."&id_user=44",
							  CURLOPT_RETURNTRANSFER => true,
							  CURLOPT_ENCODING => "",
							  CURLOPT_MAXREDIRS => 10,
							  CURLOPT_TIMEOUT => 0,
