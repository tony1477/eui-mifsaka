<?php
class RunningwatelereminderATWhatsvaCommand extends CConsoleCommand
{
	public function run($args)
	{
		...
		try
		{
			...
			$msgtele = "Selamat Pagi%0ASIAGA (System Information AKA Group - Automatic) hanya ingin mengingatkan.%0A%0A<b>JANGAN LUPA MELAKUKAN JURNAL PENYUSUTAN AKTIVA TETAP, SERTA MEMASTIKAN SEMUA SUDAH DIINPUT DENGAN TEPAT & BENAR.</b>%0A%0ATerima Kasih.";
			$pesantelegram = $msgtele;
			
			$msgwa = "Selamat Pagi\nSIAGA (System Information AKA Group - Automatic) hanya ingin mengingatkan.\n\n*JANGAN LUPA MELAKUKAN JURNAL PENYUSUTAN AKTIVA TETAP, SERTA MEMASTIKAN SEMUA SUDAH DIINPUT DENGAN TEPAT & BENAR.*\n\nTerima Kasih.";
			$pesanwhatsapp = $msgwa;
