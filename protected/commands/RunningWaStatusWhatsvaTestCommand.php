<?php
class RunningWaStatusWhatsvaTestCommand extends CConsoleCommand
{
...
*/
		...
		//Whatsva
			...
			$ch = curl_init();
			curl_setopt_array($ch, array(
			CURLOPT_URL => "https://v4.whatsva.com/api/sendText?id_device=22&tujuan=".$whatsvano."@s.whatsapp.net&message=".urlencode("Status Whatsva V4 Otomatis: *PHONE ONLINE*\n\n".$time)."&id_user=44",
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => "",
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
