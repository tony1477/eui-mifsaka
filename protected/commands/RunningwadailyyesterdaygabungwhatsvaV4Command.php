<?php
class RunningwadailyyesterdaygabungwhatsvaV4Command extends CConsoleCommand
{
...
$pesan .= $msg;
			...
			curl_setopt_array($ch, array(
				CURLOPT_URL => "https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$whatsvano."@s.whatsapp.net&message=".urlencode($pesan."\n\n_*Dikirim Otomatis oleh SIAGA (System Information AKA Group - Automatic)*_\n".$time)."&id_user=44",
			...
			$ch = curl_init();
			curl_setopt_array($ch, array(
				CURLOPT_URL => "https://v4.whatsva.com/api/sendMessageGroup?id_device=22&tujuan=".$developgroup."@g.us&message=".urlencode($pesan."\n\n_*Dikirim Otomatis oleh SIAGA (System Information AKA Group - Automatic)*_\n".$time)."&id_user=44",
				  CURLOPT_RETURNTRANSFER => true,
				  CURLOPT_ENCODING => "",
				  CURLOPT_MAXREDIRS => 10,
				  CURLOPT_TIMEOUT => 0,
