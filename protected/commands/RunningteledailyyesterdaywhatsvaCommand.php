<?php
class RunningteledailyyesterdaywhatsvaCommand extends CConsoleCommand
{
...
$pesan .= $msg;
				...
				//$telegramid = "1021823837";
				$telegramid = "-1001154554937"; //group Kangaroo Excellent
				
			//url dan kirim data untuk tele japri
				$url = Yii::app()->params['tele']."/sendMessage?chat_id=".$telegramid."&text=".urlencode($pesan);
				$ch = curl_init();
				$optArray = array(
					CURLOPT_URL => $url,
