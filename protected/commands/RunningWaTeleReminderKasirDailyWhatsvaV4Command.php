<?php
class RunningWaTeleReminderKasirDailyWhatsvaV4Command extends CConsoleCommand
{
	public function run($args)
	{
		...
		try
		{
			...
			foreach($datauser as $user)
			{
				...
				//send pesan whatsapp ke Chief Accounting
					...
					CURLOPT_URL => "https://v4.whatsva.com/api/sendText?id_device=22&tujuan=".$wauserid."@s.whatsapp.net&message=".urlencode($pesanwhatsapp."\n\n_*Dikirim Otomatis oleh SIAGA (System Information AKA Group - Automatic)*_\n".$time)."&id_user=44",
		...
		//send pesan whatsapp ke ius.tan
			...
			$ch = curl_init();
			curl_setopt_array($ch, array(
			CURLOPT_URL => "https://v4.whatsva.com/api/sendText?id_device=22&tujuan=".$whatsvano."@s.whatsapp.net&message=".urlencode($pesanwhatsapp."\n\n_*Dikirim Otomatis oleh SIAGA (System Information AKA Group - Automatic)*_\n".$time)."&id_user=44",
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => "",
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
