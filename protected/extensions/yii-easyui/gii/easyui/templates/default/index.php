<script type="text/javascript" src="<?php echo '<?php echo Yii::app()->request->baseUrl;?>'?>/js/jquery-easyui/plugins/jquery.edatagrid.js"></script>
<!-- Data Grid ( #dg-<?php echo strtolower($this->modelClass); ?> ) -->
<table id="dg-<?php echo strtolower($this->modelClass); ?>" style="width:800px;height:auto">
</table>
<div id="tb-<?php echo strtolower($this->modelClass); ?>">
	<?php echo "<?php if (\$this->CheckAccess(\$this->menuname, \$this->iswrite) == 1) {  ?>\n"?>
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-undo" plain="true" onclick="javascript:$('#dg-<?php echo strtolower($this->modelClass); ?>').edatagrid('cancelRow')"></a>
	<?php echo "<?php }?>\n";?>
