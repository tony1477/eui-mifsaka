...
class TCPDF {
	...
	// protected $print_header = true; --> ini diubah
	...
	// protected $print_footer = true; --> ini diubah
    ...
    //barcode ean13
	public function EAN13($x, $y, $barcode, $h=5, $w=.20)
	{
		$this->BarcodeEan13($x,$y,$barcode,$h,$w,13);
	}

	public function UPC_A($x, $y, $barcode, $h=5, $w=.20)
	{
	...
	function TestCheckDigit($barcode)
	{
    	...
    	public function BarcodeEan13($x, $y, $barcode, $h, $w, $len)
	{
		//Padding
		...
		$this->Cell($x+2,$y+$h+6/$this->k,substr($barcode,-$len),0,1);
